								...
								<table id="lista-noticia" class="table dataTable table-hover">
									...
									<tbody>
										...
										<tr>
                                            ...
                                            <td>
                                                <a href="<?= $this->url->get('noticias/editar') ?>/<?= $noticia->getId() ?>"><span class="glyphicon glyphicon-pencil"></span></a>
                                                <a href="<?= $this->url->get('noticias/excluir') ?>/<?= $noticia->getId() ?>"><span class="glyphicon glyphicon-remove-sign"></span></a>
                                            </td>
										</tr>
                                        <?php } ?>
									</tbody>
